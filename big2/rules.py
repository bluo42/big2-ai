...
- ``pass_locks``:       passing locks you out for the remainder of the
                        trick.  OFF in the house rules (soft pass): a pass
                        only skips your turn and you may play again if the
                        trick comes back around.
...
class RuleConfig:
    ...
    pass_locks: bool = False  # house rule: soft pass
